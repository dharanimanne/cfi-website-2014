...
class Connector {
	...
	*/
	public function render_table($table,$activity_id,$id="",$fields=false,$extra=false,$relation_id=false){
		$this->configure($table,$activity_id,$id,$fields,$extra,$relation_id);
		return $this->render();
	}
	public function configure($table,$activity_id,$id="",$fields=false,$extra=false,$relation_id=false){
        if ($fields === false){
            //auto-config
		...
		$this->request->set_activity_id($activity_id); 
